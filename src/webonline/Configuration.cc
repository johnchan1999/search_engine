...
/* string confPath = "/home/alopex/SearchEngine/conf/myConf.conf"; */
/* Configuration* Configuration::_pInstance = Configuration::getInstance(confPath); */
...
map<string, string> &Configuration::getConfigMap()
{
    ...
    while (getline(ifs, line))
    {
        ...
        iss >> first >> second; // 配置文件每行2个字段，以空格分隔
